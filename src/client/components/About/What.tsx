                ...
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="text-white">
                        <div className="inline-block px-6 py-2 bg-white/20 backdrop-blur-md rounded-full mb-6 border border-white/30">
                            <span className="text-white font-semibold orb text-sm tracking-wider">INTRODUCING ROOHSPACE</span>
                        </div>
                        ...
                        <p className="text-base text-white/95 mb-8 leading-normal">
                        ...
                        <div className="space-y-6 mb-8">
                            <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm p-5 rounded-2xl border border-white/20">
                                ...
                                <div>
                                    <h4 className="font-bold text-white orb text-lg mb-2">Spiritual Sanctuary Finder</h4>
                            ...
                            <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm p-5 rounded-2xl border border-white/20">
                                ...
                                <div>
                                    <h4 className="font-bold text-white text-lg orb mb-2">Smart & Intuitive</h4>
                                    <p className="text-white/90 leading-normal">
                            ...
                            <div className="flex items-start gap-4 bg-white/10 backdrop-blur-sm p-5 rounded-2xl border border-white/20">
                                ...
                                <div>
                                    <h4 className="font-bold text-white text-lg orb mb-2">Community-Driven Platform</h4>
                                    <p className="text-white/90 leading-normal">
                    ...
                    <div className="relative">
                        <div className="relative bg-white/15 backdrop-blur-xl rounded-3xl p-8 border border-white/30 shadow-2xl">
                            ...
                            <div className="relative space-y-6">
                                <div className="bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-sm border border-white/40">
                                    <div className="flex items-center gap-4 mb-4">
                                        <div className="w-14 h-14 bg-gradient-to-br from-[#537A5A] to-[#6B9575] rounded-xl flex items-center justify-center shadow-sm">
                                            <MapPin size={28} className="text-white" />
                                        </div>
                                        <div className="flex-1">
                                            <h4 className="font-bold text-gray-900 text-lg orb">Nearby Mosque</h4>
                                ...
                                <div className="bg-gradient-to-br from-white/95 to-white/90 backdrop-blur-sm rounded-2xl p-6 shadow-sm border border-white/40">
                                    <div className="flex items-center gap-4 mb-4">
                                        ...
                                        <div className="flex-1">
                                            <h4 className="font-bold text-gray-900 text-lg orb">Mall Prayer Room</h4>
                                ...
                                <div className="bg-gradient-to-br from-[#537A5A] to-[#6B9575] rounded-2xl p-6 text-white shadow-sm border border-white/20">
                                    <div className="flex items-center justify-between mb-3">
                                        <h4 className="font-bold text-lg orb">Your Journey Starts Here</h4>
                                        <Heart size={24} className="text-white/90" />
                                    </div>
                                    <p className="text-white/95 text-sm leading-normal">
