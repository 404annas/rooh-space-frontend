            ...
            <div className="max-w-7xl mx-auto px-4">
                <div className="grid lg:grid-cols-2 gap-16 items-center">
                    <div className="relative order-2 lg:order-1">
                        ...
                        <div className="absolute -top-6 -left-6 bg-white p-6 rounded-2xl shadow-sm">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <div className="font-bold text-green-600 orb">Less</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="order-1 lg:order-2">
                        <div className="inline-block px-6 py-2 bg-white/20 backdrop-blur-sm rounded-full mb-4">
                            <span className="text-white font-semibold text-sm orb">OUR SOLUTION</span>
                        </div>
                        <h2 className="text-4xl font-bold mb-6">
                            Your Guide to Peaceful Prayer
                        </h2>
                        <p className="text-base text-white/90 mb-8 leading-normal">
